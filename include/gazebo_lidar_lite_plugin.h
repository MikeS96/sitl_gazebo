...
#ifndef _GAZEBO_LIDAR_LITE_PLUGIN_HH_
#define _GAZEBO_LIDAR_LITE_PLUGIN_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE LidarLitePlugin : public SensorPlugin
  {
    /// \brief Constructor
    public: LidarLitePlugin();

    /// \brief Destructor
    public: virtual ~LidarLitePlugin();
